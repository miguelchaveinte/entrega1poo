...
public class Contenedor {
	...
	*/
	...
	public void hacerViajes(Contenedor contenedor,Puerto puertoOrigen,Puerto puertoDestino,Muelle muelleDestino,String fechaInicio,String fechaFin)  {
		...
		if(puertoOrigen==null)throw new IllegalArgumentException("contenedor nulo");
		if(puertoDestino==null)throw new IllegalArgumentException("contenedor nulo");
		if(muelleDestino==null)throw new IllegalArgumentException("contenedor nulo");
